...
module Generators
  ...
  # recursively.
  class ReadmeGenerator < Generators::BaseGenerator
    ...
    # generate! takes in a directory or file and writes out the README.org
    # that corresponds with said directory.
    #
    # @param [File] dir
    # @param [Array[String]] blacklisted_dirs
    # @param [Boolean] script
    def generate!(dir, blacklisted_dirs = [], script: false)
    ...
    # @param  [Boolean] script
    # @return [String]
    def get_file_desc(basename, metadata, script)
